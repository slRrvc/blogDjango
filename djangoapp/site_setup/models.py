...
class MenuLink(models.Model):
    ...
    url_or_path = models.CharField(
        max_length=2048, verbose_name='Url ou Caminho')
...
class SiteSetup(models.Model):
    ...
    show_header = models.BooleanField(
        default=True, verbose_name='Mostrar cabeçalho')
    show_search = models.BooleanField(
        default=True, verbose_name='Mostrar pesquisa')
    show_menu = models.BooleanField(default=True, verbose_name='Mostrar menu')
    show_description = models.BooleanField(
        default=True, verbose_name='Mostrar descrição')
    show_pagination = models.BooleanField(
        default=True, verbose_name='Mostrar paginação')
    show_footer = models.BooleanField(
        default=True, verbose_name='Mostrar rodapé')
